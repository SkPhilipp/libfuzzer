...
namespace Fuzzer
{
    public class Fuzzer<T>
    {
        ...
        /// <summary>
        /// "replay" a fuzzer plan by running it through an action, where the action is usually generated by a <seealso cref="FuzzerException{T}"/>.
        /// </summary>
        /// <param name="action"></param>
        public void Replay(Action<T> action)
        {
            var context = _contextBuilder();
            action(context);
        }
